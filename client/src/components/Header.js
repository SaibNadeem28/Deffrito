  ...
  return (
        ...
        <Container>
          <Row>
            ...
            <Col md={6} className="header-content">
              <h1 style={{ color: 'gray' }}>Welcome to Deffritoreist</h1>
              <p>Order our amazing food and more!</p>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <h2>About Us</h2>
            <p>
            Welcome to Deffritoreist
                {/* Welcome to Deffritoreist We are an online destination for all your shopping needs.
